...
type Credential struct {
	...
	NodeId    []byte `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"` // 20 bytes representing the Node address
	Timestamp int64  `protobuf:"varint,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`        // UTC epoch time the credential was issued
}
...
type SignedCredential struct {
	...
	Credential *Credential `protobuf:"bytes,1,opt,name=credential,proto3" json:"credential,omitempty"` // The credential itself
	Signature  []byte      `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty"`   // The HMAC signature
}

func (x *SignedCredential) Reset() {
	*x = SignedCredential{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedCredential) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedCredential) ProtoMessage() {}

func (x *SignedCredential) ProtoReflect() protoreflect.Message {
	mi := &file_credential_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedCredential.ProtoReflect.Descriptor instead.
func (*SignedCredential) Descriptor() ([]byte, []int) {
	return file_credential_proto_rawDescGZIP(), []int{1}
}

func (x *SignedCredential) GetCredential() *Credential {
	if x != nil {
		return x.Credential
	}
	return nil
...
func (x *SignedCredential) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_credential_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x22,
	0x43, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x12, 0x17, 0x0a,
	...
	0x74, 0x61, 0x6d, 0x70, 0x22, 0x69, 0x0a, 0x10, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x43, 0x72,
	0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x12, 0x37, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x63,
	...
	0x6c, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x02,
...
var file_credential_proto_goTypes = []interface{}{
	(*Credential)(nil),       // 0: credentials.Credential
	(*SignedCredential)(nil), // 1: credentials.SignedCredential
}
var file_credential_proto_depIdxs = []int32{
	0, // 0: credentials.SignedCredential.credential:type_name -> credentials.Credential
